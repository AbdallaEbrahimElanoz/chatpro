...
if(isset($_POST["register"]))
{
   ...
   $user_object->setUserProfile($user_object->make_avatar(strtoupper($_POST['user_name'][0]))); // string uppercase to value frist char 
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost/ratchet-chat-application/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
...
$(document).ready(function(){
    ...
    $('#register_form').parsley(); // send server 
