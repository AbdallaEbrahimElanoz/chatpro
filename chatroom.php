...
<body>
	<div class="container">
		<br />
        <h3 class="text-center">Realtime </h3>
        <br />
		<div class="row">
				...
				<div class="card">
					...
					<div class="input-group mb-3">
						<!-- <textarea class="form-control" id="chat_message" name="chat_message" placeholder="Type Message Here" data-parsley-maxlength="1000"  required></textarea>  -->
						 <div class="chat_massage_area">
							<div id="chat_message" contenteditable class="form-control" name="chat_message"  data-parsley-errors-container="#validation_error" >
							</div> 
							<div class="image_upload">
								<form id="uploadImage" method="Post" action="upload.php" name="chat_message"  data-parsley-errors-container="#validation_error">
									<label for="uploadFile"> <img src="./images-solid.svg"/></label>
						...
						<div class="input-group-append">
							<button  type="button" name="send"  id="send" class="btn btn-primary"  data-parsley-errors-container="#validation_error"><i class="fa fa-paper-plane"></i></button>
	...
	$(document).ready(function(){
		...
		$('#send').on('click', function(event){
			...
			if($('#send').parsley().isValid())
			{
				...
				$('#messages_area').scrollTop($('#messages_area')[0].scrollHeight);
				// $('.chat_massage_area').scrollTop($('.chat_massage_area')[0].scrollHeight);
